...
# Используйте пакетный менеджер pip для установки, обновления и удаления пакетов. Выполните следующие шаги:
#
# Проверьте установлен ли pip. Установите пакет requests. Установите конкретную версию пакета numpy (версия 1.21.0).
# Обновите пакет requests до последней версии. Удалите пакет requests. Список всех установленных пакетов.
# Требования:
...
# Используйте пакетный менеджер conda для создания и управления изолированными средами. Выполните следующие шаги:
# Создайте новую среду под названием myenv. Активируйте среду myenv. Установите пакет numpy в среду myenv. Отобразите список всех установленных пакетов в среде myenv. Деактивируйте среду myenv.
# Требования:
...
# Используйте пакет requests для выполнения GET-запроса к API. Выполните следующие шаги:
# Установите пакет requests с помощью pip. Используйте пакет requests для выполнения GET-запроса к API, например, к https://jsonplaceholder.typicode.com. Выведите на экран результат запроса.
# Требования:
